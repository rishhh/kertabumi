...
<br>
	<div>
        ...
        <div class="col-md-6" align="center">
        	...
        	<b>Supplier : @switch($kain->supplier) @case(0) Sekarniti @break @case(1) SAB @break @case(2) Lainya @endswitch</b><br><br>
        	{!! link_to('backend/kain',' Kembali',['class'=>'fa fa-backward btn btn-warning btn-sm']) !!}
